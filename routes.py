...
def download_sample(format):
    ...
    try:
        # 샘플 데이터 생성
        sample_data = {
            '거래일자': ['2024-01-15', '2024-01-16', '2024-01-17', '2024-01-18', '2024-01-19'],
            '거래시간': ['09:30:00', '14:15:30', '16:45:20', '11:20:00', '13:30:00'],
            '거래유형': ['출금', '입금', '출금', '이체', '입금'],
            '금액': [5500, 150000, 12000, 50000, 200000],
            '거래처': ['스타벅스 강남점', '클라이언트 A', '오피스디포', '내 저축계좌', '회사 급여'],
            '메모': ['커피 및 간식', '프로젝트 수수료', '사무용품 구매', '저축 이체', '월급'],
            '대상계정': ['', '', '', '저축계좌', ''],  # 이체 시에만 사용
            '분류': ['식음료', '매출', '사무용품', '', '급여'],  # 선택사항
            '부서': ['마케팅', '영업', '총무', '', '인사'],  # 선택사항
            '업체': ['스타벅스', '클라이언트A', '오피스디포', '', '']  # 선택사항
        }
