...
def download_sample(format):
    ...
    try:
        # 샘플 데이터 생성
        sample_data = {
            '계정': ['KB국민은행 주거래', 'KB국민은행 주거래', '신한카드 법인카드', 'KB국민은행 주거래', '우리은행 급여계좌'],  # 필수: 계정명 또는 ID
            '거래일자': ['2024-01-15', '2024-01-16', '2024-01-17', '2024-01-18', '2024-01-19'],  # 필수: YYYY-MM-DD
            '거래시간': ['09:30:00', '14:15:30', '16:45:20', '11:20:00', '13:30:00'],  # 선택사항: HH:MM:SS
            '거래유형': ['출금', '입금', '출금', '이체', '입금'],  # 필수: 입금/출금/이체
            '금액': [5500, 150000, 12000, 50000, 200000],  # 필수: 숫자만
            '거래처': ['스타벅스 강남점', '클라이언트 A', '오피스디포', '내 저축계좌', '회사 급여'],  # 필수: 상대방 정보
            '메모': ['커피 및 간식', '프로젝트 수수료', '사무용품 구매', '저축 이체', '월급'],  # 선택사항: 거래 내용
            '대상계정': ['', '', '', 'KB국민은행 저축계좌', ''],  # 선택사항: 이체 시 받는 계정
            '분류': ['식음료', '매출', '사무용품', '', '급여'],  # 선택사항: 카테고리명
            '부서': ['마케팅', '영업', '총무', '', '인사'],  # 선택사항: 부서명
            '업체': ['스타벅스', '클라이언트A', '오피스디포', '', '회사'],  # 선택사항: 업체명
            '계좌번호': ['110-123-456789', '110-123-456789', '1234-5678-9012', '110-123-456789', '567-890-123456']  # 선택사항: 참고용 계좌번호
        }
